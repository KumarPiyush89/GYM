...
<header>
	<nav>
		...
		<div class="menu">
			...
			<a href="Customer.php">Customer</a>
			<a href="Trainer.php">TRAINER</a>-->
			<!--<a href="./CheckPhp/Checkone.php">Our Work</a>-->
			<a href="./CheckPhp/AllCheck.php">Our Work</a>
	...
	<div class="container">
		...
		<button class="btn btn-info"><a href="signup.php">Join us</a></button>
		</div>
	</div>
</header>
</div>
	...
	<div class="row">
		...
		<div class="col-sm-5">
			...
			<p><span class="text-info">STRENGTH TRAINING</span><br/><br/>				
				Welcome to Our Gym! I have been an expert in <br/>
				crossfit and endurance training for more than 5 years now,<br/>
				and would love for us to get together and train a little! <br/>
				Come over to Our if you would like to learn from me, and<br/>
				be better at what you dreamt of doing.<br/><br/>
				
				We are the best gym in Gaya and here, we don’t just talk big,<br/>
				...
				gym in Gaya, Our Gym.</p>
		</div>
		<div class="col-sm-5">
			<img src="images/WhatsApp Image 2023-05-02 at 21.51.57.jpg" alt="" title="" style="height: 100%; width: 70%;border-radius: 30%;
