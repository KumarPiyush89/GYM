...
<body>
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12 text-center"><br/>
                <h1 class="text-light"><i class="ri-presentation-line"> &nbsp;</i><b style="color:red;">TRAI</b><b >NER</b><br/></h1>
    ...
    $stmt=$conn->prepare("SELECT * FROM `gym` WHERE Category LIKE'T%';");

    $stmt->execute();
    $gyms=$stmt->fetchAll();
    ?>
    <table class="text-light text-center table  table-borderless" >
        <?php
